  ...
  metrics: [
    {
      ...
      description: "Revenue acceleration achieved in the first year leading channel sales.",
    },
    {
      value: 42,
      prefix: "$",
      ...
      description: "Strategic pipeline shaped through partner-led and enterprise opportunities.",
    },
    {
      value: 58,
      suffix: "+",
      label: "Partners launched or reactivated",
      description: "Expanded channel reach by activating and re-engaging high-value partners.",
    },
    {
      value: 31,
      suffix: "%",
